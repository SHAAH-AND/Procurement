...
export class RfqsController {
  ...
  async create(@Body() dto: {
    ...
    title?: string; reference?: string; currency?: string;
    bidStart?: string; bidEnd?: string; awardDate?: string;
    documents?: string; team?: string;
  }, @Req() req: any) {
    ...
    const rfq = await this.tenant.client.rfq.create({
      data: {
        ...
        bidStart: dto.bidStart ? new Date(dto.bidStart) : null,
        bidEnd: dto.bidEnd ? new Date(dto.bidEnd) : null,
        awardDate: dto.awardDate ? new Date(dto.awardDate) : null,
        documents: dto.documents || null,
        team: dto.team || null,
        dueDate: (dto.bidEnd || dto.dueDate) ? new Date((dto.bidEnd || dto.dueDate) as string) : null,
